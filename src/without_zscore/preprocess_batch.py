# PS F:\October-Thesis\thesis-epilepsy-gnn> python "src/without_zscore/preprocess_batch.py" --input_dir "F:\October-Thesis\thesis-epilepsy-gnn\data_raw\DATA" --output_dir "F:\October-Thesis\thesis-epilepsy-gnn\data_pp\without_zscore" --psd_dir "F:\October-Thesis\thesis-epilepsy-gnn\figures\without_zscore\psd" --max_patients 5 --pad-missing
import sys
