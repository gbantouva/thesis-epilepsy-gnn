...
1. Continuous preprocessed EEG signal  
2. Segmented, cleaned epochs  
3. Binary diagnostic labels (epilepsy vs. non-epilepsy)  
4. Metadata including electrode names, sampling frequency, and preprocessing parameters  
